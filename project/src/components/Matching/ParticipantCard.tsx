          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${experienceColors[participant.experience as keyof typeof experienceColors]}`}>
              ...
              {participant.skills.slice(0, 4).map((skill) => (
                <span
                  ...
                  className={`px-2 py-1 rounded text-xs font-medium ${
                    participant.commonSkills.includes(skill)
